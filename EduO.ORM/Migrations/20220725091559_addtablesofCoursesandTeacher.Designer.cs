...
namespace EduO.ORM.Migrations
{
    ...
    [Migration("20220725091559_addtablesofCoursesandTeacher")]
    partial class addtablesofCoursesandTeacher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduO.Core.Models.Course", b =>
                {
                    b.HasOne("EduO.Core.Models.CourseType", "CourseType")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("EduO.Core.Models.Fee", b =>
                {
                    b.HasOne("EduO.Core.Models.Course", "Course")
                        .WithOne("Fee")
                        .HasForeignKey("EduO.Core.Models.Fee", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduO.Core.Models.Student", b =>
                {
                    ...
                    b.HasOne("EduO.Core.Models.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("EduO.Core.Models.Student", "UserId")
            ...
            modelBuilder.Entity("EduO.Core.Models.Teacher", b =>
                {
                    b.HasOne("EduO.Core.Models.User", "User")
                        .WithOne("Teacher")
                        .HasForeignKey("EduO.Core.Models.Teacher", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
